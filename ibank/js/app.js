...
function decoratePage(templateParams) {
    decorateTemplate('page-header', 'div.page-header', templateParams);
    decorateTemplate('page-footer', 'div.page-footer', templateParams);
    decorateTemplate('page-navbar', 'div.page-navbar', templateParams);
}
